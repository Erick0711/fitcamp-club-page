...
<div class="hero-full-wrapper">
  ...
  <div class="gutter-sizer"></div>
    ...
    <div class="grid-item">
      <img class="img-responsive" alt="" src="./img/ejercicio-2.jpg">
    ...
    <div class="grid-item">
      <img class="img-responsive" alt="" src="../img/comidas.jpg">
      <a href="./project.html" class="project-description">
        <div class="project-text-holder">
          <div class="project-text-inner">
            <h3>Vivamus vestibulum</h3>
    ...
    <div class="grid-item">
      <img class="img-responsive" alt="" src="./img/proteinas-herbalife.jpg">
      <a href="./project.html" class="project-description">
        <div class="project-text-holder">
          <div class="project-text-inner">
            <h3>Vivamus vestibulum</h3>
    ...
    <div class="grid-item">
      <img class="img-responsive" alt="" src="./img/comidas-2.jpg">
      <a href="./project.html" class="project-description">
        <div class="project-text-holder">
          <div class="project-text-inner">
            <h3>Vivamus vestibulum</h3>
    ...
    <div class="grid-item">
      <img class="img-responsive" alt="" src="./img/comidas-3.jpg">
      <a href="./project.html" class="project-description">
        <div class="project-text-holder">
          <div class="project-text-inner">
            <h3>Vivamus vestibulum</h3>
    ...
    <div class="grid-item">
      <img class="img-responsive" alt="" src="./img/proteina-hb.jpg">
      <a href="./project.html" class="project-description">
        <div class="project-text-holder">
          <div class="project-text-inner">
            <h3>Vivamus vestibulum</h3>
    ...
    <div class="grid-item">
      <img class="img-responsive" alt="" src="./img/herbalife.png">
      <a href="./project.html" class="project-description">
        <div class="project-text-holder">
          <div class="project-text-inner">
            <h3>Vivamus vestibulum</h3>
